module DebugParser.ElmValue exposing
    ( ElmValue(..), ExpandableValue(..), PlainValue(..), SequenceType(..)
    , toggle, hasNestedValues
    )

{-| ElmValue

@docs ElmValue, ExpandableValue, PlainValue, SequenceType
@docs toggle, hasNestedValues
...
Expandable values has bool as their first parameter, which is used to indicate whether they are expanded or contracted. This is used in UI
...
it later on large models is really costly. This might change in the upcoming versions of parser.
